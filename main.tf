...
resource "null_resource" "configure-cat-app" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "chmod +x *.sh",
      "PLACEHOLDER=${var.placeholder} WIDTH=${var.width} HEIGHT=${var.height} PREFIX=${var.prefix} APP_SECRET=${data.hcp_vault_secrets_secret.web_application.secret_name} ./deploy_app.sh",
